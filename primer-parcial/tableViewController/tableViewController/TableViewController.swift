    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if( segue.identifier == "mostrar" ){
            ...
            viewAgregar.delegado = self // hacemos que la variable delegado de ViewControllerAgregar apunte a este view controller (TableViewController)
    ...
    // MARK: - métodos de protocolos protocoloAgregarJugador
