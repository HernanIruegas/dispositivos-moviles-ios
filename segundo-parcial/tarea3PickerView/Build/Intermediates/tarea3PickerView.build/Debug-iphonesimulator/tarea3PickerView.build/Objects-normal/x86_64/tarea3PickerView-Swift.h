...
SWIFT_CLASS("_TtC16tarea3PickerView11AppDelegate")
...
SWIFT_CLASS("_TtC16tarea3PickerView19FirstViewController")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified lbNumber;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified lbLetter;
@property (nonatomic, readonly, copy) NSArray<NSArray<NSNumber *> *> * _Nonnull Array;
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nonnull numeros;
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nonnull letras;
...
SWIFT_CLASS("_TtC16tarea3PickerView20SecondViewController")
...
@property (nonatomic, copy) NSArray<UIImage *> * _Nonnull imagenes;
- (NSInteger)numberOfComponentsInPickerView:(UIPickerView * _Nonnull)pickerView;
- (NSInteger)pickerView:(UIPickerView * _Nonnull)pickerView numberOfRowsInComponent:(NSInteger)component;
